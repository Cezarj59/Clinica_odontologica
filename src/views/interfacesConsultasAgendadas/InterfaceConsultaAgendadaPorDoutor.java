 ...
 * @author cezarj59
 */
public class InterfaceConsultaAgendadaPorDoutor extends javax.swing.JFrame {

    /**
     * Creates new form InterfacePrincipal
     */
    public InterfaceConsultaAgendadaPorDoutor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONSULTAS AGENDADAS POR DOUTOR");
        ...
        jMenuItem13.setText("Consultas Ativas");
    ...
    private void buttonListarDados1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonListarDados1ActionPerformed
        ...
        if (inputNome.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Digite o nome do Doutor!");
        } else {
            readJTable();
        }
    ...
    public void readJTable() {
        ...
        for (ConsultaAgendamento p : pController.getDoutor(inputNome.getText())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceConsultaAgendadaPorDoutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceConsultaAgendadaPorDoutor().setVisible(true);
            }
        });
    }
